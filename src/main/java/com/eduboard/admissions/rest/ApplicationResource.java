...
import com.eduboard.admissions.service.ApplicationService;
...
public class ApplicationResource {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApplicationDTO> getApplication(@PathVariable final Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateApplication(@PathVariable final Long id,
            @RequestBody @Valid final ApplicationDTO applicationDTO) {
